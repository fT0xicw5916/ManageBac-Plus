...
class ManagebacDriver:
    ...
    def __init__(self, username, password, microsoft=False):
        self.class_excludes = ["Homeroom", "Study Hall", "Bedtime", "SDL", "历史", "政治", "Orchestra", "Physics Studio", "Library self-study", "Creative Economics"]
        ...
        self.grades_xpath = "/html/body/div[2]/div[1]/aside/div[2]/div[1]/div[2]/div[1]/section[2]/div/*"
        self.tasks_xpath = "/html/body/div[2]/div[1]/main/div/section/div/div[2]/*"
